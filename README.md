...
- 📖 A structured list of Bangladeshi tech companies  
- 🔍 Easy navigation by **A–Z order**  
- 🛠️ Key details: Location, Tech Stack, Website, LinkedIn, Reviews  

---

## 🏢 Companies List

> **Note**: Companies are listed alphabetically. Use Ctrl+F to search for specific companies or technologies.
...
### Quick Search Tips:
- **Find by Technology**: Press `Ctrl+F` and search for "React", "Python", "Java", etc.
- **Find by Location**: Search "Gulshan", "Banani", "Sylhet", etc.
- **Find by Rating**: Search "⭐4" for 4+ star companies
- **Find by Specialization**: Search "AI", "Blockchain", "Mobile", etc.

### Popular Technologies:
- **Frontend**: React, Vue.js, Angular, JavaScript, TypeScript
- **Backend**: Java, Python, PHP, Node.js, .NET, Go
...
We welcome all contributions! To add or update a company:  

1. **Fork** this repository  
2. **Add company info** in alphabetical order  
3. **Include the following details:**  
   ...
   - ⭐ Rating (if available on review sites)  
...
Feel free to use, share, and build upon this data.  
